...
// Child.prototype = Parent.prototype; 如果直接把Parent的原形链赋值给Child的原形链，没有办法继承到父类构造函数内定义的属性方法。
...
Child.prototype = Object.create(Parent.prototype); // 调用Object.create，实现原形链继承
